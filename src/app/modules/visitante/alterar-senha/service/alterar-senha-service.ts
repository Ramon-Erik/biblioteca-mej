...
import { SolicitarAlteracaoResponse, SolicitarAlteracaoRequest, AlterarSenhaResponse, AlterarSenhaRequest } from '../interfaces/alterar-senha';
...
export class AlterarSenhaService {
  ...
  public solicitarAlteracao(email: string): Observable<SolicitarAlteracaoResponse> {
    ...
    return this.http.post<SolicitarAlteracaoResponse>(
      `${this.apiUrl}/solicitar-alteracao`,
      body
    );
  }
  ...
  public confirmarAlteracao(
    ...
    return this.http.post<AlterarSenhaResponse>(
      `${this.apiUrl}/confirmar-alteracao`,
      body
    );
  }
